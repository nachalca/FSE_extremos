...
*Where*
  ...
  * $\hat{A}_d$: Predicted amplitude of day d.
  
### Maximum correlation

$$
\frac{\sum_{d=1}^D \mathbbm{1}_{mh_d = \hat{mh}_d}}{D}
$$
...
if (conf[["VARIABLES"]][[params$variable]][["daily"]]) {
  ...
  monthly_boxplot_2(res)
}
```

`r  if (conf[["VARIABLES"]][[params$variable]][["daily"]]) {"### Daily amplitudet\n"}`
