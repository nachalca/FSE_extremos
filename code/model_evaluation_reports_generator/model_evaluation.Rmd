...
I have to check which metric is used (gain or weight).

```{r xgboost_explanation}
importance <- data.frame(features = unlist(model$feature_names_in_), importance = unlist(model$feature_importances_)) |>
