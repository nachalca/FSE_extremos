...
library(reticulate)
use_python("/home/tancre/bin/miniconda3/bin/python", required = TRUE)
library(yaml)
library("extremogram")
...
The function $\mathbb{1}_{E_d=\hat{E}_d}}$ is an indicator function that equals 1 when both of the days have and extreme value and 0 when one has an extreme value but the other don't.
...
```{r extremes}
mean_on_days_with_extremes_plot(res, standarize=T)
```
