...
- Climate variables used as response: 
...
- Training: 
      ...
      - Predictors: from upscaled ERA5 (daily or monthly)
...
- Validation: 
    - Period:  `r min(res$time)` to `r max(res$time)`
    - Variable to predict: reduced scale ERA5 variable  
