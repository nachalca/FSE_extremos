...
knnreg <- knnreg |> rename("knnreg_sfcWind" = "sfcWind")
```
...
amplitude_difference_of_means(res$time, res$obs_sfcWind, res$knnr_sfcWind)
...
p3 <- maximum_histograms(res$time, res$obs_sfcWind, res$nv2_sfcWind) + scale_fill_discrete(labels = c("knnr", "obs"))
p4 <- maximum_histograms(res$time, res$obs_sfcWind, res$knnreg_sfcWind) + scale_fill_discrete(labels = c("knnr", "obs"))
